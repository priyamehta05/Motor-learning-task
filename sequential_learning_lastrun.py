...
expName = 'sequential_learning'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\admin\\Documents\\psychopy\\sequential_learning_lastrun.py',
...
trials = data.TrialHandler(nReps=12.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/admin/Documents/psychopy/sequence_learning.xlsx'),
